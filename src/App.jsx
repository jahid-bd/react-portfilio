...
// Components
import SectionHeader from './components/Golbal/SectionHeading';
import Progress from './components/SkillSection/Progress';
import ResumeItem from './components/ResumeSection/ResumeItem';
import ResumeHeader from './components/ResumeSection/ResumeHeader';
import ContentBox from './components/ServicesSection/ContentBox';
import TestimonalItem from './components/TestimonalSection/TestimonalItem';
import DotBtn from './components/TestimonalSection/DotBtn';
import CountBox from './components/FactSection/CountBox';
import InputGroup from './components/ContactSection/InputGroup';

// Images
import heroBg from './assets/img/hero-bg.jpg';
import jahid from './assets/img/jahid.jpg';
import PortfolioItem from './components/PortfolioSection/PortfolioItem';
            ...
            {/* Portfolio Section */}
                <section id="portfolio" className="portfolio">
                    ...
                    <Row className="portfolio-container">
                        <PortfolioItem image= {img1} title='App 1'/>
